...
const About = () => {
  return (
    <div className='mt-32 mx-4 md:mx-20'>

      <div className='mt-3'>
        <h3 className='text-3xl md:text-5xl font-bold leading-snug mb-5 shadow-md'>
          Hi, thanks for visiting our bookstore. <span className="text-blue-950">Our mission and vision are mentioned below.</span>
        </h3>

        <div className='flex flex-col md:flex-row md:justify-center md:space-x-8'>
          <Card className="mb-5 md:mb-0 max-w-md mx-auto" imgSrc={img}>
            <h5 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
              Values and Philosophy:
            </h5>
            <p className="font-normal text-gray-700 dark:text-gray-400">
              The values and philosophy of a bookstore help define its identity, guide its decision-making, and shape its interactions with customers and the community.
            </p>
          </Card>

          <Card className="mb-5 md:mb-0 max-w-md mx-auto" imgSrc={img2}>
            <h5 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
              Selection of Books:
            </h5>
            <p className="font-normal text-gray-700 dark:text-gray-400">
              Curating and offering a specific range of books for sale or display within the application. The book selection is a critical aspect that influences the identity of the bookstore and the satisfaction of our customers.
            </p>
          </Card>
        </div>

        <div className='flex flex-col md:flex-row md:justify-center md:space-x-8 mt-8'>
          <Card className="mb-5 md:mb-0 max-w-md mx-auto" imgSrc={img3}>
            <h5 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
              Community Engagement:
            </h5>
            <p className="font-normal text-gray-700 dark:text-gray-400">
            ...
            <div className='flex justify-center space-x-4 mt-4'>
              <a href="https://twitter.com/AmanCha11979357" target="_blank" rel="noopener noreferrer">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" className="cursor-pointer text-blue-400" viewBox="0 0 512 512">
                  <path fill="#03a9f4" d="M512 97.248c-19.04 8.352-39.328 13.888-60.48 16.576 21.76-12.992 38.368-33.408 46.176-58.016-20.288 12.096-42.688 20.64-66.56 25.408C411.872 60.704 384.416 48 354.464 48c-58.112 0-104.896 47.168-104.896 104.992 0 8.32.704 16.32 2.432 23.936-87.264-4.256-164.48-46.08-216.352-109.792-9.056 15.712-14.368 33.696-14.368 53.056 0 36.352 18.72 68.576 46.624 87.232-16.864-.32-33.408-5.216-47.424-12.928v1.152c0 51.008 36.384 93.376 84.096 103.136-8.544 2.336-17.856 3.456-27.52 3.456-6.72 0-13.504-.384-19.872-1.792 13.6 41.568 52.192 72.128 98.08 73.12-35.712 27.936-81.056 44.768-130.144 44.768-8.608 0-16.864-.384-25.12-1.44C46.496 446.88 101.6 464 161.024 464c193.152 0 298.752-160 298.752-298.688 0-4.64-.16-9.12-.384-13.568 20.832-14.784 38.336-33.248 52.608-54.496z"/>
                </svg>
              </a>
              <a href="https://www.facebook.com/neha.chaurasiya.1804109/" target="_blank" rel="noopener noreferrer">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" className="cursor-pointer text-blue-700" viewBox="0 0 512 512">
                  ...
                  <path fill="#fff" d="M355.65 330L367 256h-71v-48.021c0-20.245 9.918-39.979 41.719-39.979H370v-63s-29.296-5-57.305-5C254.219 100 216 135.44 216 199.6V256h-65v74h65v178.889c13.034 2.045 26.392 3.111 40 3.111s26.966-1.066 40-3.111V330z"/>
                </svg>
              </a>
              <a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" className="cursor-pointer text-pink-600" viewBox="0 0 24 24">
                  <linearGradient id="a" x1="-37.106" x2="-26.555" y1="-72.705" y2="-84.047" gradientTransform="matrix(0 -1.98 -1.84 0 -132.522 -51.077)" gradientUnits="userSpaceOnUse">
          ...
          <Card className="mb-5 md:mb-0 max-w-md mx-auto" imgSrc={img4}>
            <h5 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
              Customer Testimonials:
            </h5>
            <p className="font-normal text-gray-700 dark:text-gray-400">
              Customers expressing their thoughts, opinions, and experiences regarding their interactions with the bookstore. They provide feedback and reviews with ease.
            </p>
          </Card>
        </div>

        <div className='flex flex-col md:flex-row md:justify-center md:space-x-8 mt-8'>
          <Card className="mb-5 md:mb-0 max-w-md mx-auto" imgSrc={img5}>
            <h5 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
              Unique Selling Proposition (USP):
            </h5>
            <p className="font-normal text-gray-700 dark:text-gray-400">
              The Unique Selling Proposition is a critical aspect of marketing strategy that helps a bookstore differentiate itself from competitors.
            </p>
          </Card>

          <Card className="mb-5 md:mb-0 max-w-md mx-auto" imgSrc={img6}>
            <h5 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
              Call to Action (CTA):
            </h5>
            <p className="font-normal text-gray-700 dark:text-gray-400">
              Our services are always available to guide you for the enhanced use of our bookstore app. To understand every feature, you can easily reach out to us.
            </p>
          </Card>
        </div>
      </div>
